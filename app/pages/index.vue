...
<template>
  <div>
    ...
    <div class="home-header">
      ...
      <div class="btn-group">
        <NuxtLink to="/blog" class="btn-primary">🚀 进入博客文章</NuxtLink>
        <NuxtLink to="/wiki" class="btn-primary">🚀 进入 Wiki 知识库</NuxtLink>
      </div>
    </div>
    ...
    <section class="content-page">
      ...
      <div class="section-header">
        <h2>📖 最新 Wiki</h2>
        <NuxtLink to="/wiki" class="btn-primary">
          查看更多 <span class="icon">📖</span>
        </NuxtLink>
      </div>
      <WikiList :limit="5" />
